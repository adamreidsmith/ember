...
def test_init():
    ...
    assert_equal(sim._sv._size, 0, 'init')
...
def test_run():
    ...
    true_sv = List[ComplexScalar[DType.float64]](
        (2.97539264e-01, +1.38777878e-17),
        (0.00000000e+00, +0.00000000e+00),
        (0.00000000e+00, +6.65355582e-02),
        (0.00000000e+00, +0.00000000e+00),
        (4.40260322e-01, +4.40260322e-01),
        (0.00000000e+00, +0.00000000e+00),
        (-9.84507585e-02, +9.84507585e-02),
        (0.00000000e+00, +0.00000000e+00),
        (-6.22622118e-01, +1.38777878e-17),
        (0.00000000e+00, +0.00000000e+00),
        (3.46944695e-18, -1.39230398e-01),
        (0.00000000e+00, +0.00000000e+00),
        (-2.10392031e-01, -2.10392031e-01),
        (0.00000000e+00, +0.00000000e+00),
        (4.70477444e-02, -4.70477444e-02),
        (0.00000000e+00, +0.00000000e+00)
    )
    sim = StatevectorSimulator()
    sim.run[False](qc)
    ...
    sim = StatevectorSimulator()
    true_sv = List[ComplexScalar[DType.float64]](
        ( 1.47729760e-01, -3.03081706e-02),
        (8.30296019e-02, +1.25891828e-01),
        (-8.71134185e-02, -3.03081706e-02),
        (-8.30296019e-02, -4.01673760e-02),
        (-1.36810794e-01, +5.66688863e-02),
        (-8.50715102e-02, -7.80999992e-02),
        (8.50715102e-02, +7.80999992e-02),
        (2.63607157e-02, +6.36403972e-02),
        (-3.03081706e-02, -1.47729760e-01),
        (1.25891828e-01, -8.30296019e-02),
        (-3.03081706e-02, +8.71134185e-02),
        (-4.01673760e-02, +8.30296019e-02),
        (-4.92960268e-03, +1.15379681e-01),
        (-1.36810794e-01, +5.66688863e-02),
        (-2.63607157e-02, -6.36403972e-02),
        (4.92960268e-03, -1.15379681e-01),
        ...
        (-1.09189659e-02, -2.63607157e-02),
        (2.04190829e-03, -4.77918286e-02),
        (2.04190829e-03, -4.77918286e-02),
        (5.66688863e-02, -2.34730213e-02),
        (-2.42420977e-17, -8.30769703e-17),
        (5.17255062e-17, -9.20961270e-17),
        (-3.10061067e-17, +1.21466613e-16),
        (-6.57020466e-17, +1.09338646e-16),
        (3.52377733e-02, +3.23500789e-02),
        (1.09189659e-02, +2.63607157e-02),
        (5.66688863e-02, -2.34730213e-02),
        (3.52377733e-02, +3.23500789e-02),
        (1.25891828e-01, +8.30296019e-02),
        ...
        (3.03081706e-02, -8.71134185e-02),
        (4.01673760e-02, -8.30296019e-02),
        (-7.28127445e-02, -1.25811422e-01),
        (5.89068375e-02, -1.27095535e-01),
        (-3.38540148e-02, +3.24916102e-02),
        (1.66117788e-02, +2.04677474e-02),
        (1.47729760e-01, -3.03081706e-02),
        (8.30296019e-02, +1.25891828e-01),
        (-8.71134185e-02, -3.03081706e-02),
        (-8.30296019e-02, -4.01673760e-02),
        (-1.35195739e-01, -4.50851505e-02),
        (-8.53261735e-02, -9.52245430e-02),
        (1.92346128e-02, +4.36859618e-02),
        (4.57703399e-02, -2.30382335e-03),
        (6.75794685e-17, +7.40796150e-17),
        (-7.71785496e-17, +5.25687771e-17),
        (-2.25965613e-17, -9.00153324e-17),
        (-1.96544390e-17, -4.91988822e-17),
        (4.25045739e-02, -2.19183374e-02),
        (6.69849904e-02, +4.40659333e-02),
        (3.54584422e-03, +5.46218083e-02),
        (-5.67791548e-02, +6.25618545e-02),
        (9.83929008e-17, -2.59482552e-17),
        (3.17498172e-17, +2.25537412e-17),
        (-2.13141674e-17, -1.42011919e-17),
        (-4.96219986e-17, +1.37560183e-17),
        (-1.25340203e-02, +7.53933211e-02),
        (2.29657161e-03, -3.06672848e-02),
        (6.78788057e-02, -1.33777912e-02),
        (3.72592620e-02, +4.24711993e-02),
        (-8.30296019e-02, +1.25891828e-01),
        (-1.47729760e-01, -3.03081706e-02),
        (8.30296019e-02, -4.01673760e-02),
        (8.71134185e-02, -3.03081706e-02),
        (5.93000966e-02, -6.86037504e-02),
        (1.81792998e-02, +5.47250532e-02),
        (-1.19477012e-01, +4.04105114e-02),
        (-1.06832871e-01, -4.36952085e-02),
        (1.25891828e-01, +8.30296019e-02),
        (-3.03081706e-02, +1.47729760e-01),
        (-4.01673760e-02, -8.30296019e-02),
        (-3.03081706e-02, -8.71134185e-02),
        (-8.39929675e-02, -4.81933418e-03),
        (4.08898621e-03, -9.25648094e-02),
        (1.05664422e-01, +4.55538774e-02),
        (6.71006278e-02, +1.01215368e-01),
        (-2.85914805e-17, +1.83949019e-16),
        (-1.39981294e-16, -5.60567966e-17),
        (5.34049858e-17, -5.97038098e-17),
        (1.39681845e-16, -8.35616151e-17),
        (2.37295054e-02, -5.72880775e-02),
        (1.29550460e-01, -2.44168825e-02),
        (3.64474096e-02, -2.43135464e-04),
        (1.97194527e-02, +7.40033791e-02),
        (1.30364152e-17, +3.72152459e-17),
        (1.53089725e-17, +1.42260809e-16),
        (1.49955922e-17, -8.68422565e-17),
        (-3.97006645e-17, +4.75866301e-18),
        (-4.18988603e-02, -7.82102677e-02),
        (2.62191844e-02, -5.51649503e-02),
        (-6.54970463e-02, +3.74757245e-02),
        (-3.67924572e-02, -1.41019499e-02),
    )
    sim.run[False](qc)
    sv = sim.get_statevector()
...
def test_measure():
    ...
    true_svs.append(( #0
        Statevector[tol=1e-4](CMatrix(16, 1,
            (9.83549677e-02, 0.30721174),
            (0.00000000e+00, 0.),
            (4.45744714e-02, 0.11015756),
            (0.00000000e+00, 0.),
            (3.07201906e-01, 0.13179566),
            (0.00000000e+00, 0.),
            (-3.39521349e-02, 0.58717916),
            (0.00000000e+00, 0.),
            (-1.10505740e-01, -0.31916187),
            (0.00000000e+00, 0.),
            (2.19837560e-01, 0.21638093),
            (0.00000000e+00, 0.),
            (-4.14408821e-01, -0.20654543),
            (0.00000000e+00, 0.),
            (1.20976610e-05, -0.02301506),
            (0.00000000e+00, 0.)
        )),
        Statevector[tol=1e-4](CMatrix(16, 1,
            (0., 0.00000000e+00), 
            (0.09776907, -4.12742218e-01),
            (0., 0.00000000e+00), 
            (-0.33217571, 0.00000000e+00),
            (0., 0.00000000e+00), 
            (0.12273502, -9.94271270e-02),
            (0., 0.00000000e+00), 
            (0.20241046, 1.71042696e-01),
            (0., 0.00000000e+00), 
            (0.18127464, -9.90968043e-05),
            (0., 0.00000000e+00), 
            (0.51965397, 3.32207937e-01),
            (0., 0.00000000e+00), 
            (0.10908705, 4.35059141e-01),
            (0., 0.00000000e+00), 
            (0.00805665, 8.05665076e-03)
        )),
    ))
    true_svs.append(( #1
        Statevector[tol=1e-4](CMatrix(16, 1,
            (0.08984617, 2.80634501e-01),
            (0.10903012, -4.60281911e-01),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (0.28062552, 1.20393863e-01),
            (0.13687165, -1.10879154e-01),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (-0.10094576, -2.91550811e-01),
            (0.20215387, -1.10510785e-04),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (-0.37855784, -1.88676950e-01),
            (0.12165171, 4.85169300e-01),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00)
        )),
        Statevector[tol=1e-4](CMatrix(16, 1,
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (3.92159044e-02, 0.09691486),
            (-3.56767815e-01, 0.),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (-2.98705432e-02, 0.5165908) ,
            (2.17395599e-01, 0.18370557),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (1.93409556e-01, 0.19036847),
            (5.58125736e-01, 0.35680243),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (1.06433280e-05, -0.02024828),
            (8.65311218e-03, 0.00865311)
        )),
    ))
    true_svs.append(( #2
        Statevector[tol=1e-4](CMatrix(16, 1,
            (0.08385067, 2.61907567e-01),
            (0.10175446, -4.29566980e-01),
            (0.03800112, 9.39127500e-02),
            (-0.34571631, 0.00000000e+00),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (-0.09420958, -2.72095423e-01),
            (0.18866401, -1.03136324e-04),
            (0.18741836, 1.84471473e-01),
            (0.54083682, 3.45749851e-01),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00),
            (0., 0.00000000e+00)
        ...
        Statevector[tol=1e-4](CMatrix(16, 1,
            ...
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (2.90999508e-01, 0.12484451),
            (1.41931437e-01, -0.11497807),
            (-3.21614363e-02, 0.55621024), 
            (2.34068549e-01, 0.1977947),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (0.00000000e+00, 0.),
            (-3.92552132e-01, -0.19565184),
            (1.26148855e-01, 0.50310474),
            (1.14596080e-05, -0.02180121),
            (9.31675444e-03, 0.00931675),
        )),
    ))
    true_svs.append(( #3
        Statevector[tol=1e-4](CMatrix(16, 1,
        ...
        Statevector[tol=1e-4](CMatrix(16, 1,
            ...
            (0.00000000e+00, 0.00000000e+00),
            (0.00000000e+00, 0.00000000e+00),
            (-9.54601564e-02, -2.75707325e-01),
            (1.91168407e-01, -1.04505396e-04),
            (1.89906223e-01, 1.86920220e-01),
            (5.48016100e-01, 3.50339471e-01),
            (-3.57986207e-01, -1.78423846e-01),
            (1.15040899e-01, 4.58804177e-01),
            (1.04505396e-05, -1.98815143e-02),
            (8.49637364e-03, 8.49637364e-03),
        )),
    ))
    for q in range(4):
        qcn = qc
        ...
        for _ in range(trials):
            ...
            counts[clbit] += 1
            if sv0._size == 0 and clbit == 0:
                sv0 = sim.get_statevector()
            if sv1._size == 0 and clbit == 1:
    ...
    sv10_t = Statevector[tol=1e-4](CMatrix(16, 1,
        ...
        (0., 0.00000000e+00),
        (0., 0.00000000e+00),
        (-0.13427824, -3.87821423e-01),
        (0.26890546, -1.47001649e-04),
        (0., 0.00000000e+00),
        (0., 0.00000000e+00),
        (-0.50355833, -2.50978425e-01),
        (0.16182133, 6.45373093e-01),
        (0., 0.00000000e+00),
        (0., 0.00000000e+00),
    ))
    sv11_t = Statevector[tol=1e-4](CMatrix(16, 1,
        ...
        (0.00000000e+00, 0.), 
        (0.00000000e+00, 0.),
        (2.70029372e-01, 0.26578355),
        (7.79229036e-01, 0.49815085),
        (0.00000000e+00, 0.), 
        (0.00000000e+00, 0.),
        (1.48597165e-05, -0.0282697),
        (1.20810703e-02, 0.01208107),
    ))
    for _ in range(trials):
        sim.run(qc)
        ...
        cts[state_str] += 1
        if sv00._size == 0 and state_str == '00':
            sv00 = sim.get_statevector()
        if sv01._size == 0 and state_str == '01':
            sv01 = sim.get_statevector()
        if sv10._size == 0 and state_str == '10':
            sv10 = sim.get_statevector()
        if sv11._size == 0 and state_str == '11':
